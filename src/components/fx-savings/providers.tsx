...
// the how-it-works steps and the closer already carry Talk to us.
//
...
const StripeMark = (
  <svg viewBox="0 0 24 24" className="fxs-prov__mark" aria-hidden="true">
...
const BankMark = (
  <svg viewBox="0 0 24 24" className="fxs-prov__mark" aria-hidden="true" fill="currentColor">
...
const PROVIDERS: Provider[] = [
  {
    icon: StripeMark,
    title: 'Stripe',
    body: 'Your checkout and integrations stay as they are. Only the payout account changes.',
  },
  {
    icon: ShopifyMark,
    title: 'Shopify',
...
export function FxSavingsProviders() {
  const talk = useContactLink('fx_provider', 'fx_providers')

  return (
    <section className="section fxs-prov">
      <div className="container">
        ...
        <p className="section__sub">
          ...
          Tell us what you use and{' '}
          <a
            href={talk.href}
            className="fxs-prov__talk"
            onClick={(event) => {
              track({ name: 'fx_savings_cta_click', location: 'providers', target: 'talk_to_us' })
              talk.onClick(event)
            }}
          >
        ...
        <div className="why__grid why__grid--three why__grid--four fxs-prov__grid" role="list">
          {PROVIDERS.map((p) => (
