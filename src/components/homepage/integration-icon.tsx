...
export function IntegrationIcon({ id, large }: { id: string; large?: boolean }) {
  ...
  if (id === 'shopify') {
    ...
    return (
      ...
      >
        <img className="intg__shopify-mark-black" src="/homepage/shopify-bag-black.webp" alt="Shopify" width={size} height={size} loading="lazy" decoding="async" />
        <img className="intg__shopify-mark-white" src="/homepage/shopify-bag-white.webp" alt="Shopify" width={size} height={size} loading="lazy" decoding="async" />
      </span>
    )
  }
  if (id === 'iframe') {
