      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2">
            <span className="font-semibold text-xl tracking-tight text-foreground">quidkey</span>
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-border bg-white max-h-[80vh] overflow-y-auto">
          <nav className="px-4 py-4 space-y-4">
            ...
            {/* Simple links */}
            <a href="#pricing" className="block py-2 font-medium text-foreground" onClick={() => setMobileMenuOpen(false)}>
              Pricing
            </a>
