...
export const Route = createFileRoute('/workflows')({
  ...
  head: () =>
    buildSeo({
      ...
      description:
        'Automate what happens after payment: tax holds, splits, refund reserves, FX, and payouts. Write plain-English rules with deterministic execution and audit trails.',
      path: '/workflows',
    }),
})
