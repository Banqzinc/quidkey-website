...
const SECTIONS: LegalSectionDef[] = [
  ...
  { id: 'what-is', title: 'What is a complaint?' },
  { id: 'how', title: 'How do I complain?' },
  { id: 'process', title: 'What happens when a complaint is made?' },
]
  ...
  return (
    <LegalShell
      ...
      hero={{
        ...
        lede: 'How to submit a complaint to Quidkey, what we will do with it, and how to escalate to the Financial Ombudsman Service if you are not satisfied with our response.',
        meta: [
          { k: 'Effective', v: 'June 2025' },
          { k: 'First response', v: 'Within 1 business day' },
          { k: 'Target resolution', v: '5 business days' },
          { k: 'Contact', v: 'support@quidkey.com' },
        ],
      }}
      sections={SECTIONS}
    >
      ...
      <LegalSection id="what-is" num={2} title="What is a complaint?">
        <div className="prose prose-gray max-w-none">
      ...
      <LegalSection id="how" num={3} title="How do I complain?">
        <div className="prose prose-gray max-w-none">
          <p className="text-muted-foreground mb-6">
      ...
      <LegalSection id="process" num={4} title="What happens when a complaint is made?">
        <div className="prose prose-gray max-w-none">
          <p className="text-muted-foreground mb-6">
      ...
      <ContactCard
        topic="our complaints procedure"
        email="support@quidkey.com"
        showComplaintsLink={false}
      />
    </LegalShell>
  )
}
